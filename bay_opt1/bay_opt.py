...
def bay_sample(compl, xx, yy, n_interv=100):
...
if __name__ == '__main__':
    ...
    compl.load('./saved_models/model_7_5.mdl')

    peaks = gen_params()
    # xx, yy, _, _ = gen_data(2, peaks)
    # mu, sig = bay_sample(compl, xx, yy)

    # plot_all('result.png', peaks, mu, sig, xx, yy)

    # peaks = gen_params()
    # iterative_plot(peaks)
